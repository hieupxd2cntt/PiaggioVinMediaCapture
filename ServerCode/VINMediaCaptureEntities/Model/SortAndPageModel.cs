...
namespace VINMediaCaptureEntities
{
    ...
    public class Pager
    {
        ...
        private string GetFirstLink()
        {
            ...
            {
                return
                    "<li class='prev paginate_button page-item previous'><a class='page-link'  tabindex='8' title='First' onclick=\"PagerClick(1);\"><i class='fa fa-angle-double-left'></i></a></li>";
            }
            return "";
        }
        ...
        private string GetFirstLink(string functionName)
        {
            ...
            {
                return
                    "<li class='paginate_button page-item previous prev'><a  class='page-link' tabindex='8' title='First' onclick='" + functionName + "(" + "1" + ")" + "'><i class='fa fa-angle-double-left'></i></a></li>";
            }
            return "";
        }
        ...
        private string GetLastLink()
        {
            ...
            {
                return "<li class='paginate_button page-item next'><a class='page-link' tabindex='50' title='Last' onclick=\"PagerClick(" + _totalPages +
        ...
        private string GetLastLink(string functionName)
        {
            ...
            if ((CurrentPage < _totalPages) && (_totalPages > 0))
            {
                return "<li class='next'><a  class='page-link' tabindex='50' title='Last' onclick='" + functionName + "(" + _totalPages + ")" + "'><i class='fa fa-angle-double-right'></i></a></li>";
            }
            return "";
        }
        ...
        private string GetLink(int pageNum)
        {
            ...
            {
                return "<li class='active paginate_button page-item'><a  class='page-link' tabindex='" + (10 + pageNum) + "' >" + pageNum + "</a></li>";
            }
            return "<li class='paginate_button page-item'><a  class='page-link' tabindex='" + (10 + pageNum) + "' onclick=\"PagerClick(" + pageNum + ");\">" + pageNum + "</a></li>";
        }
        ...
        private string GetLink(int pageNum, string functionName)
        {
            ...
            if (pageNum == CurrentPage)
            {
                return "<li class='active paginate_button page-item'><a  class='page-link' tabindex='" + (10 + pageNum).ToString() + "'>" + pageNum + "</a></li>";
            }
            return "<li><a  class='page-link' onclick='" + functionName + "(" + pageNum + ")" + "' tabindex='" + (10 + pageNum).ToString() + "'>" + pageNum + "</a></li>";
        }
        ...
        private string GetNextLink()
        {
            ...
            if ((CurrentPage < _totalPages) && (_totalPages > 0))
            {
                return "<li class='next paginate_button page-item'><a  class='page-link' title='Next' tabindex='20' onclick=\"PagerClick(" + (CurrentPage + 1) +
        ...
        private string GetNextLink(string functionName)
        {
            ...
            if ((CurrentPage < _totalPages) && (_totalPages > 0))
            {
                return "<li class='next paginate_button page-item next'><a  class='page-link' tabindex='20' title='Next' onclick='" + functionName + "(" + (CurrentPage + 1).ToString() + ")" + "'><i class='fa fa-angle-right'></i></a></li>";
            }
            return "";
        }
        ...
        private string GetPreviousLink()
        {
            ...
            if ((CurrentPage > 1) && (_totalPages > 0))
            {
                return "<li class='prev paginate_button page-item previous'><a  class='page-link' tabindex='10' title='Prev' onclick=\"PagerClick(" + (CurrentPage - 1) +
        ...
        private string GetPreviousLink(string functionName)
        {
            ...
            if ((CurrentPage > 1) && (_totalPages > 0))
            {
                return "<li class='prev paginate_button page-item previous'><a class='page-link' tabindex='10' title='Prev' onclick='" + functionName + "(" + (CurrentPage - 1).ToString() + ")" + "'><i class='fa fa-angle-left'></i></a></li>";
            }
            return "";
        }
