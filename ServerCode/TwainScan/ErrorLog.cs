...
namespace TwainScan
{
    public class ErrorLog {
        ...
        {
            var common = Common.Common.GetConfig();
            string AppPath = Path.Combine(common.LogPath);
            ...
            try {
                ...
                StreamWriter sw = new StreamWriter(common.LogPath);
                
                sw.WriteLineAsync(e.ToString());
                sw.Flush();
                sw.Dispose();
                sw.Close();
                if (sLogFile != null) {
